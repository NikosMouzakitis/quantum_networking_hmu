...
%3 MORE 
		...
		\textbf{Quantum entanglement} is the situation where two qubits become correlated (called \textit{entanglement pair}) in a way that
		...
		from one location into another without that particle beeing trasported. This incident is feasible due to the entanglement.
...
\chapter{Related Work}
	...
	\chapter{Methodology and Results}
		...
		affected by depolarizing noise \cite{depolarization}. Fidelity calculates how close the state is to the desired state. 
		...
		In practise values less than 0.5 indicates that the state is unsuitable for further quantum processing.
		In Figure 3.4 we can inspect that as the noise level increases, the fidelity decreases,
